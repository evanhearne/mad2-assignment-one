...
@Composable
fun LoginScreen(modifier: Modifier = Modifier, context: Context, onNavigateToHome: () -> Unit, onNavigateToRegistration: () -> Unit) {
    // Email string
    ...
    Column {
        Row {
            // TopAppBar
            TopAppBar(
                title = { Text(stringResource(R.string.login_screen_top_app_bar_title)) },
            )
        }
        // Besco Icon
...
fun LoginScreenPreview() {
    LoginScreen(context = LocalContext.current, onNavigateToHome = {}, onNavigateToRegistration = {})
}